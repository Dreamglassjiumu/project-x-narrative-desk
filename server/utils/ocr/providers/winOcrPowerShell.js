...
export const provider = {
  ...
  async recognize(imagePath) {
    ...
    try {
      const { stdout } = await execFileAsync(command, ['-ExecutionPolicy', 'Bypass', '-File', scriptPath, '-Path', imagePath, '-Lang', language], { timeout: timeoutMs, maxBuffer: maxOutputBytes, windowsHide: true });
