...
export const providers = [paddleOcrHttp, paddleOcrCli, tesseractCli, manualFallback];
...
export const getOcrProviderStatus = async () => {
  ...
  return {
    ...
    source: active === 'tesseract-cli' ? (tesseract.source || 'none') : active,
    ...
    languageStatus: tesseract.languageStatus || { eng: false, chi_sim: false },
