...
export interface OcrProviderStatus { id: string; label: string; available: boolean; message?: string; languages?: string[]; languageStatus?: { eng?: boolean; chi_sim?: boolean }; languageWarnings?: string[]; error?: string; source?: string; mode?: string; url?: string; command?: string; script?: string; }
