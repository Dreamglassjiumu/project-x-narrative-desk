...
export const zh = {
  ...
  nav: { dashboard: '案件总览', factions: '帮派档案', districts: '区域与地点', characters: '角色卷宗', storylines: '剧情线', pitch: 'Pitch 写作台', library: '本地资料库', intake: '证物接收台', 'design-assets': '设计资料' },
  ...
  parserMode: { 'Auto Detect': '自动识别', 'Faction Sheet': '帮派表', 'Character Sheet': '角色表', 'District Sheet': '区域表', 'POI Sheet': '地点表', 'Storyline Sheet': '剧情线表', 'Raw Text': '原始文本', 'Image Evidence': '图片', 'Existing Archive JSON': '已有档案 JSON', Sheet: '工作表', raw_document: '原始文档', '图片 OCR': '图片 OCR', 'OCR 文本建档': 'OCR 文本建档', 'Image OCR': '图片 OCR', 'Clipboard Screenshot + External OCR Text': '截图 + 外部 OCR 文本', 'Windows OCR + Clipboard Screenshot': 'Windows OCR + 截图' } as Record<string, string>,
  assetType: { characters: '角色', factions: '帮派', districts: '区域', pois: '地点', storylines: '剧情线', 'design-assets': '设计资料' } as Record<AssetType, string>,
  assetCategory: { Character: '角色', Faction: '帮派', District: '区域', POI: '地点', Storyline: '剧情线', 'Design Asset': '设计资料' } as Record<string, string>,
