...
export const zh = {
  ...
  parserMode: { 'Auto Detect': '自动识别', 'Faction Sheet': '帮派表', 'Character Sheet': '角色表', 'District Sheet': '区域表', 'POI Sheet': '地点表', 'Storyline Sheet': '剧情线表', 'Raw Text': '原始文本', 'Image Evidence': '图片', 'Existing Archive JSON': '已有档案 JSON', Sheet: '工作表', raw_document: '原始文档', '图片 OCR': '图片 OCR', 'OCR 文本建档': 'OCR 文本建档', 'Image OCR': '图片 OCR' } as Record<string, string>,
