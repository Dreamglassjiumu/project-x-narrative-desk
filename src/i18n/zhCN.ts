...
export const zh = {
  ...
  noTags: '无标签',
  buttons: {
    newRecord: '新建档案', closeFile: '关闭档案', close: '关闭', closeX: '关闭 ×', save: '保存', saveDossier: '保存档案', delete: '删除', edit: '编辑', cancel: '取消', createDossier: '创建档案', bindToDossier: '绑定到档案', upload: '上传', uploadToIntake: '上传到接收台', addAllLockerFiles: '添加全部本地文件', readPreview: '读取预览', generateParsedDrafts: '生成解析草稿', batchApproveFile: '批量确认入库', approveFile: '确认入库', mergeExisting: '合并到已有档案', reject: '驳回', previewJson: '预览 JSON', editDraft: '编辑草稿', clearFilters: '清空筛选', apply: '应用', selectVisible: '选择当前可见项', selectNone: '取消选择', selectEvidence: '选择证物', selectDraft: '选择草稿', openDossier: '打开档案', openFolder: '打开文件夹', insertPitchOutline: '插入 Pitch 提纲', exportMarkdown: '导出 Markdown', loadPitch: '读取 Pitch', duplicate: '复制', clearDraft: '清空草稿', previous: '上一张', next: '下一张', zoomIn: '放大', zoomOut: '缩小', reset: '还原', fitToScreen: '适应屏幕', replaceImage: '替换图片', removePrimaryImage: '移除主图', setPrimaryEvidence: '设为主证物图', chooseEvidenceFiles: '选择证物文件', saveMetadata: '保存信息', saveBindings: '保存绑定', exportJson: '导出 JSON 包', previewImport: '预览导入', executeImport: '执行导入', convertStoryline: '转为剧情线草稿', clearRejected: '清除已驳回', approveSelected: '确认所选入库', showMapping: '显示字段映射', hideMapping: '隐藏字段映射'
  },
  nav: { dashboard: '总览', factions: '帮派档案', districts: '区域与地点', characters: '角色卷宗', storylines: '剧情线', pitch: 'Pitch 写作台', library: '本地资料库', intake: '证物接收台' },
  statusLine: { online: '本地数据同步已就绪 · 系统：仅本地', offline: '本地接口离线 · 只读模式' },
  evidence: { document: '文档证物', image: '图片证物', photoBag: '图片证物袋', documentBag: '文档证物袋', unfiled: '未归档证物', linkedDossiers: '已绑定档案', primaryFor: '主图用于', fileUsage: '文件用途', keepUsage: '保持当前用途', addTags: '添加标签', tagPlaceholder: '输入后按 Enter', allFileUsage: '全部文件用途', all: '全部', linked: '已绑定', unlinked: '未绑定', uploadNewImage: '上传新图片', chooseExistingEvidence: '选择已有证物', clickBindUpload: '点击绑定或上传图片', dropPrimaryHere: '将主证物图放在这里', uploadedAt: '上传时间', fileType: '文件类型', size: '大小', path: '路径', copyPath: '复制本地证物路径', openLinkedDossier: '打开关联档案' },
  ...
  parserMode: { 'Auto Detect': '自动识别', 'Faction Sheet': '帮派表', 'Character Sheet': '角色表', 'District Sheet': '区域表', 'POI Sheet': '地点表', 'Storyline Sheet': '剧情线表', 'Raw Text': '原始文本', 'Image Evidence': '图片证物', 'Existing Archive JSON': '已有档案 JSON', Sheet: '工作表', raw_document: '原始文档' } as Record<string, string>,
